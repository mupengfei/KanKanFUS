...
public class UploadController {
    ...
    @RequestMapping("/tkp")
    public String tokenp(String name, String size,String jsonpCallback, String kankan_video_usertoken)
            throws ServletException, IOException {

        Map<String, Object> json = kankan_video_usertoken ==null? getToken(name,size):getToken(name,size,kankan_video_usertoken);
     	JSONObject js = new JSONObject(json);
        jsonpCallback=  jsonpCallback+"("+js.toString()+")";
        logger.info(  jsonpCallback);
    ...
    public String fileInfo(String token )
            throws ServletException, IOException {
    ...
    private Map<String, Object> getToken(String name, String size ) throws IOException{
    ...
    private Map<String, Object> getToken(String name, String size, String vCode) throws IOException{
    	 /**
         * 获取 Token
         *
         */
    ...
    public Map<String, Object> formData(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
    ...
    public void upload_GET(String token, String size, String name, HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
    ...
    public void upload_POST(HttpServletRequest req, HttpServletResponse resp)
    	...
    	logger.info(    "upload    POST 1" );
    	setOptions(req,resp);
    	logger.info(    "upload    POST 2" );
    ...
    private  void setOptions(HttpServletRequest req, HttpServletResponse resp)
        ...
        resp.setHeader("Access-Control-Allow-Origin",configService.getCrossOrigins() );
